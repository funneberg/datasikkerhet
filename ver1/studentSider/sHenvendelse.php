    ...
    <div class="content">
		  	...
		  	<div  class="level-left">
			  	...
			  	<form>
			    	...
			    	<div class="level-item">
						...
						<div class="level-item">
							<button class="button is-primary" name="sendinn">  Send inn </button>
						</div>
		...
		<div class="container">
			...
			<div class="column">
				...
				<form action="sHenvendelse.php" method="get">
					<input type="text" name="text">
						...
						<?php
							...
							if(isset($_GET['sendinn'])) {
								...
								$foreleser = "SELECT epost FROM foreleser WHERE emnekode = '$dropdownEmner';";

								$result = mysqli_query($con, $foreleser);
								...
								//$sql = "SELECT epost FROM foreleser WHERE emnekode = '$dropdownEmner'";"
								/*$sql = "INSERT INTO henvendelse (avsender, mottaker, emnekode, henvendelse)
									VALUES ($username, $foreleser , $dropdownEmner , $text);"; */
